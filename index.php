...
<!--<video width="320" height="440" controls class="videobox">
    <source src="vid/VID_341860417_210513_130.mp4" type="video/mp4">
  ...
  Your browser does not support the video tag.
    ...
    <video  controls class="videoHeader">
    <source src="vid/MuayThaiIntro_0.mp4" type="video/mp4">
    </video>
  <div class="maininfo">
<h1 class="logotext"  style="color: color: #00E676;"><a><u>TRI</u>BE</a>  </h1>
    <h2 class="subtext" style="color: color: #00E676;">Fitness Training  & Personal Development Community </h2>
  </div>
</div>
</section>

<section>
  <div class="site_promo">
    <div id="main">
        <h3> What is TRIBE<h3>
        <p>  "TRIBE" is a fight and fitness community that is not afraid to stand out. We are always challenging the status quo, reaching goals, and dominating in what we do.</p>
        <p> In a tribe, we learn from one another and live the best version of ourselves. </p>
          <p>Get where you need to be. </p>
        <br> 
        Get connected. Sign up is free. <br><br>
        <a href="register.php" class="btn btn-primary"> <h4>  Free Sign Up </h4> </a>
      </div>
    </div>
</section>
      ...
      <H2>(In Beta phase) </H2>
        ...
        <div class="iconbox">
         <i class="fa fa-group" style="font-size:30px"></i>
          ...
          <h4>Join for Free</h4>
          <p>Free membership site.</p>
      </div>
      <div class="featureboxes">
        <div class="iconbox">
          <i class="fa fa-ra" style="font-size:30px"></i>
        </div>
          <h4>Community</h4>
          <p>Connect with active like minded people.</p>
      </div>
      <div class="featureboxes">
        <div class="iconbox">
